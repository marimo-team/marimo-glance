 ...
 */
export function playgroundUrl(source: string, opts: PlaygroundOptions = {}): string {
...
export function renderNotebookAsIframe(source: string, options: RenderOptions = {}): HTMLElement {
